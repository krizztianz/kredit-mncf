...
<html lang="en">
    ...
    <head>
        ...
        <title>MFin Microsite - Login</title>

        <!-- page css -->
        <link href="{!$base_url!}Assets/Admin/dist/css/pages/login-register-lock.css" rel="stylesheet">
        <!-- Custom CSS -->
    ...
    <body class="skin-default card-no-border">
        ...
        <div class="preloader">
            <div class="loader">
                ...
                <p class="loader__label">MNC Finance</p>
            </div>
        </div>
        <!-- ============================================================== -->
        ...
        <!-- ============================================================== -->
        <section id="wrapper">
            <div class="login-register" style="background-image:url({!$base_url!}Assets/Admin/images/background/login-register.jpg);">
                <div class="login-box card">
                    <div class="card-body">
                        <form class="form-horizontal form-material" method="post" id="loginform" action="{!$site_url!}account/postlogin">
