...
var companyName = "MNF Finance"; // Enter your event title
...
function loadMap(addressData){
    document.getElementById('gmapsfrm').src = addressData.value;
//  var path = document.URL;
//      path = path.substring(0, path.lastIndexOf("/") + 1);
//
//  var locationContent = "<h2>"+addressData.caption+"</h2>"
...
//                    path+"Assets/Front/img/mapmarker.png",
...
$("#location-map-select").append('<option value="">Please select a location</option>');  
$.each(locations, function( index, value ) {
  //console.log(index);
  var option = '<option value="'+index+'">'+value.caption+'</option>';
